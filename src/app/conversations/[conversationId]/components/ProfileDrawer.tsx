                        ...
                        <div className="absolute inset-0 overflow-hidden">
                            <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
                                ...
                                >
                                    ...
                                    >
                                        <div className="flex flex-col bg-white py-6 h-full shadow-xl overflow-y-scroll">
                                            ...
                                            <div className="relative mt-6 flex-1 px-4 sm:px-6">
                                                <div className="flex flex-col items-center">
                                                    ...
                                                    <div className="flex gap-10 my-8">
                                                        <div className="flex flex-col gap-1 items-center cursor-pointer hover:opacity-75">
                                                            <div
                                                    ...
                                                    <div className="w-full py-5 sm:px-0 sm:pt-0">
                                                        <dl className="space-y-8 px-4 sm:space-y-6 sm:px-6">
                                                            {data.isGroup ? (
                                                                <>
                                                                    <div>
                                                                        <dt className="text-xl font-medium text-gray-500 sm:w-40 sm:flex-shrink-0">
                                                                            Emails
                                                                        </dt>
